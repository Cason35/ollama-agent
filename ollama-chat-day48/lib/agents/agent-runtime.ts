...
export class AgentRuntime { /* 定义第40天基于 Supervisor 的智能体运行时。 */
  ...
  constructor(private readonly registry: AgentRegistry, private readonly workspaceStore: WorkspaceStore = new MemoryWorkspaceStore(), private readonly usageStore: UsageManager = usageManager, private readonly cacheStore: SemanticCache = semanticCache) {} /* 第48天：在第47天依赖注入基础上追加共享语义缓存，让运行时具备缓存命中能力。 */
