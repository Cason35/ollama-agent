export type RedisOperationName = "GET" | "SET" | "DEL" | "EXPIRE" | "EXISTS" | "KEYS" | "TTL" | "TYPE" | "MEMORY" | "PING" | "LPUSH" | "RPUSH" | "LRANGE" | "LREM" | "LLEN"; /* 第59天：扩展 Redis 操作名称，新增 Redis List（列表）命令用于分布式队列。 */
