...
const componentLabels: Record<UsageComponentType, string> = { agent: "Agent（智能体）", tool: "Tool（工具）", reflection: "Reflection（反思）", evaluation: "Evaluation（评估）", collaboration: "Collaboration（模型协作）" }; /* 第56天：补充模型协作组件类型的中英文展示名称。 */
