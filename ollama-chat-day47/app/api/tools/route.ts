 ...
 */
import { apiJsonSuccess } from "@/lib/api/api-envelope"; // 统一 Envelope
import { toolToDescriptor } from "@/lib/tools/tool-registry"; // 描述符转换
import { workflowToolRegistry } from "@/lib/workflow/workflow-tools"; // 全局注册表
