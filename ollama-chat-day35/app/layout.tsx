...
export const metadata: Metadata = { // 导出浏览器标签页与页面描述元数据。
  title: "Day 35 - Queue Runtime V5 | Rate Limit + Resource Control", // 设置第35天浏览器标签页标题。
  description: "Day 35：Queue Runtime V5，支持 ResourceLimiter、RateLimiter、resourceType、blockedReason、Resource Usage 与 Rate Limit Metrics。", // 设置第35天页面描述。
}; // metadata 定义结束。
