export type JobStatus = "queued" | "running" | "success" | "failed" | "retrying" | "dead_letter"; // 定义后台任务状态，保留排队、运行、成功、失败、重试中和死信状态。
...
export type JobTimelineItem = { // 定义任务生命周期时间线条目。
  label: "Created" | "Scheduled" | "Claimed" | "Started" | "Completed" | "Failed" | "RetryScheduled" | "DeadLetter" | "Requeued" | "StaleRecovered" | "Blocked"; // 第35天：补充 Blocked 节点，用于记录资源或速率阻塞。
