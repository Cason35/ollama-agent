...
export type TraceSpanType = "agent" | "tool" | "workflow" | "queue" | "reflection" | "retrieval" | "evaluation" | "cache" | "memory" | "collaboration"; /* 第56天：扩展 collaboration（模型协作）跨度类型，用于追踪多模型阶段链路。 */
