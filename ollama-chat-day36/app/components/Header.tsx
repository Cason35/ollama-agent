      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h1 className="mt-1 text-2xl font-semibold tracking-tight text-zinc-900 dark:text-zinc-50 sm:text-3xl">
            Queue Runtime V6 · Cancellation + Timeout + Graceful Shutdown
          </h1>
          <p className="mt-2 max-w-2xl text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
            第36天：在 day35 的 Queue Runtime V5 基础上升级 Queue Runtime V6，支持 cancelJob、cooperative cancellation、
            timeout wrapper 与 WorkerPool graceful shutdown，同时保留 ResourceLimiter / RateLimiter / priority / schedule / retry / backoff / DLQ。侧栏仍可 Import 笔记、观察向量写入并调试检索；需
            Ollama{" "}
