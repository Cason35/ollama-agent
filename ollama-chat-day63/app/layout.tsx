...
export const metadata: Metadata = { // 第62天：导出浏览器标签页与页面描述元数据。
  title: "Day 63 - Secrets Management | 密钥管理", // 第63天：设置浏览器标签页标题为密钥管理主题。
  description: "Day 63：Production Infrastructure V6，基于 SecretItem、SecretProvider、SecretsManager、AES-256-GCM、Secret Rotation、Secret Masking 和 Secrets Explorer 构建密钥管理能力。", // 第63天：设置页面描述为密钥管理核心能力。
}; // 第62天：结束 metadata 定义。
