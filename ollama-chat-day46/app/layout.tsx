...
export const metadata: Metadata = { // 导出浏览器标签页与页面描述元数据。 
  title: "Day 46 - Bad Case Management & Regression Evaluation | Continuous Evaluation System", // 第46天：设置浏览器标签页标题。
  description: "Day 46：持续评估系统，新增 Evaluation Dataset、Bad Case Management、Batch Evaluation、Regression Comparison 和 Quality Gate。", // 第46天：设置页面描述。
}; // metadata 定义结束。 
