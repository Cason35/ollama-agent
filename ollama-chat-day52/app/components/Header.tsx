...
const day52Description =
  "第52天：在 Resilient Multi-Model Runtime（具备容错能力的多模型运行时）基础上加入 Prompt Registry（提示词注册表）、Prompt Versioning（提示词版本管理）、Prompt Renderer（提示词渲染器）、Prompt Diff（提示词差异对比）与 Prompt Rollback（提示词回滚）。系统现在可以知道每次 Agent、Tool、Reflection 和 Evaluation 使用了哪个 promptId / promptVersion，并把它们关联到 Usage（用量）、Trace（追踪）和 Regression（回归评估）。";
        ...
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <h1 className="mt-1 truncate text-xl font-semibold tracking-tight text-zinc-950 dark:text-zinc-50 sm:text-2xl">
              ...
              <span className="ml-2 text-zinc-500 dark:text-zinc-400">提示词生命周期管理</span>
            </h1>
          </div>
        </div>
