...
export type TraceSpanType = "agent" | "tool" | "workflow" | "queue" | "reflection" | "retrieval" | "evaluation" | "cache" | "memory"; /* 第49天：在第48天 Cache（语义缓存）基础上扩展 Memory（长期记忆）跨度类型，支持长期经验检索与写回观测。 */
