...
export function buildSamplePromptVariables(prompt: PromptTemplate): Record<string, string> { /* 第52天增强：定义提示词预览样例变量构造函数。 */
  ...
  const samples: Record<string, string> = { task: "分析 Day 53 Prompt Experiment Platform 的候选提示词治理能力。", tools: "retrieval, ragAnswer, summary", memory: "长期记忆：Day 52 已具备 Prompt Registry、Prompt Diff 和 Activate Gate。", workspace: "共享工作空间：上一个 step 总结了实验候选版本、成本和回归风险。", agentId: prompt.componentId, output: "上游输出：已经完成资料检索、风险整理和下一步建议。", threshold: "80", agents: "research, planner, writer, critic" }; /* 第53天增强：定义所有内置变量的样例值，并更新为 Day 53 场景。 */
