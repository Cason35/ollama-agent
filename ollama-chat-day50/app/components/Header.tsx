...
const day50Description =
  "第50天：通过 ModelProfile、ModelRegistry、ModelRoutingInput 与 ModelRouter 实现按任务选择模型。简单总结走 small-chat，复杂规划走 large-reasoning，结构化输出走 json-structured，评估走 evaluation，嵌入走 embedding；并接入 Agent Runtime、Tool Runtime 与 Usage 成本归因，保留 Day 49 的长期记忆、语义缓存、用量观测、持续评估、队列、工作流、RAG、工具注册表、WorkerPool 与 Quality Gate。";
        ...
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <h1 className="mt-1 truncate text-xl font-semibold tracking-tight text-zinc-950 dark:text-zinc-50 sm:text-2xl">
              Multi-Model Routing Runtime
              <span className="ml-2 text-zinc-500 dark:text-zinc-400">多模型路由运行时</span>
            </h1>
          </div>
        </div>
