...
import type { KnowledgeDocumentSummary, KnowledgeMetricsSnapshot, QueryRewriteDebug, RetrievalMode, RetrievedChunkHit } from "@/lib/knowledge/knowledge-types"; // 第29天：RAG V6 类型
...
export default function HomePage() {
  ...
  /** 第29天：加载知识库指标、文档数与 Knowledge Explorer 数据。 */
  ...
  /** 第29天：导入笔记到知识库（contentHash → chunkHash → 增量 embedding → save）。 */
