      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h1 className="mt-1 text-2xl font-semibold tracking-tight text-zinc-900 dark:text-zinc-50 sm:text-3xl">
            RAG Runtime V6 · Knowledge Store + Incremental Indexing
          </h1>
          <p className="mt-2 max-w-2xl text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
            第29天：在 Memory-aware Retrieval Pipeline 基础上升级 Knowledge Store，支持 Document Version、Content Hash、Chunk Hash、
            Incremental Indexer、Embedding Cache、Knowledge Explorer 与 Reindex Tool。侧栏可 Import 笔记、观察增量索引并调试检索；需
            Ollama{" "}
