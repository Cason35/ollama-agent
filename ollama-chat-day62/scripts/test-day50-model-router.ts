...
function buildSampleModel(): ModelProfile { /* 第50天：定义构造一个示例模型档案的工具函数。 */
  return { id: "unit-chat", name: "Unit Chat", provider: "ollama", model: "demo:1b", capabilities: ["chat", "summary"], roles: ["writing", "summary"], cost: { inputPer1K: 0.0001, outputPer1K: 0.0002 }, limits: { contextWindow: 4096, maxOutputTokens: 512 }, speed: "fast", quality: "basic" }; /* 第56天：返回一条带 roles 的单元测试模型档案。 */
} /* 第50天：结束示例模型构造函数。 */
