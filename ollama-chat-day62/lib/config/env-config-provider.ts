...
const ENV_MAPPINGS: EnvMapping[] = [ // 第62天：定义 Day62 支持读取的环境变量映射表。
  ...
  { envKey: "XIAOMI_MIMO_API_KEY", configKey: "model.mimoApiKey", type: "string" }, // 第62天：映射 MiMo API Key。
  ...
  { envKey: "MINIO_ACCESS_KEY", configKey: "storage.minioAccessKey", type: "string" }, // 第62天：映射 MinIO Access Key。
  { envKey: "MINIO_SECRET_KEY", configKey: "storage.minioSecretKey", type: "string" }, // 第62天：映射 MinIO Secret Key。
