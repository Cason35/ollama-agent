...
export function ChatToolbar({
  ...
  const selectFieldClass =
    "rounded-xl border-0 bg-zinc-100 px-3 py-2 text-sm text-zinc-800 ring-1 ring-zinc-200/80 focus:outline-none focus:ring-2 focus:ring-violet-500/30 dark:bg-zinc-800 dark:text-zinc-100 dark:ring-zinc-700"; // 下拉控件统一样式
