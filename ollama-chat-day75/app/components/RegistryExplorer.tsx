...
const TYPE_LABELS: Record<RegistryFilter, string> = { all: "全部", agent: "Agent", tool: "Tool", model: "Model", prompt: "Prompt", memory: "Memory", knowledge: "Knowledge", workflow: "Workflow", evaluation: "Evaluation", observability: "Observability", governance: "Governance" }; // 第73天：扩展注册类型过滤按钮以展示身份、权限、配额和审计治理能力。
