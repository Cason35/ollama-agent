...
import { configManager } from "@/lib/config/config-runtime"; // 第62天：引入配置中心，统一读取 WorkerPool 并发配置。
...
const DEFAULT_CONCURRENCY = configManager.getNumber("runtime.maxWorkers", 3); // 第62天：从配置中心读取 WorkerPool 默认并发数。
