...
const TYPE_LABELS: Record<RegistryFilter, string> = { all: "全部", agent: "Agent", tool: "Tool", model: "Model", prompt: "Prompt", memory: "Memory", knowledge: "Knowledge", workflow: "Workflow", evaluation: "Evaluation", observability: "Observability" }; // 第72天：扩展注册类型过滤按钮以展示生产可观测能力。
