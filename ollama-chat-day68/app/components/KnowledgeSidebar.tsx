...
export function KnowledgeSidebar({
  ...
  const [activePanel, setActivePanel] = useState<"registry" | "events" | "context" | "secrets" | "config" | "storage" | "lock" | "queue" | "runtime" | "redis" | "experiment" | "prompt" | "collaboration" | "model" | "memory" | "cache" | "usage" | "knowledge" | "records">("memory"); /* 第68天：默认打开记忆面板，并通过页头入口进入 Production Memory Platform 治理台。 */
