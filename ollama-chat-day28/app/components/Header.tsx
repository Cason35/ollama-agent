      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h1 className="mt-1 text-2xl font-semibold tracking-tight text-zinc-900 dark:text-zinc-50 sm:text-3xl">
            RAG Runtime V5 · Memory-aware Retrieval Pipeline
          </h1>
          <p className="mt-2 max-w-2xl text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
            第28天：在上一版 Query Rewrite / Multi-Query Retrieval 基础上升级为 Memory-aware Retrieval Pipeline，支持 ambiguous
            detector、memory / recent messages、knowledgeTopics、fallback LLM、pipeline metrics 与 RAG Debug Panel V5。侧栏可 Import 笔记并调试检索；需
            Ollama{" "}
