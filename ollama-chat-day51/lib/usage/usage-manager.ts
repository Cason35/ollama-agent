...
import type { CostBreakdownItem, ModelUsageAggregate, PromptROIResult, PromptROIVariant, PromptROIVariantInput, UsageAggregate, UsageComponentType, UsageMetrics, UsageRecord, UsageRecordInput } from "@/lib/usage/usage-types"; /* 第47天：引入用量管理器需要的全部结构类型（第50天追加模型用量聚合类型）。 */
