      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h1 className="mt-1 text-2xl font-semibold tracking-tight text-zinc-900 dark:text-zinc-50 sm:text-3xl">
            Queue Runtime V7 · Workflow as Job
          </h1>
          <p className="mt-2 max-w-2xl text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
            第37天：在 day36 的 Queue Runtime V6 生命周期控制基础上升级 Queue Runtime V7，把 Workflow 正式变成 Job，
            由 Queue、Worker、Retry、Cancel 和 Unified Timeline 驱动执行，同时保留 ResourceLimiter / RateLimiter / priority / schedule / backoff / DLQ。侧栏仍可 Import 笔记、观察向量写入并调试检索；需
            Ollama{" "}
