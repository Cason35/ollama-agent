...
export const metadata: Metadata = { // 导出浏览器标签页与页面描述元数据
  title: "Day 31 - Queue Runtime V1 · Local Job Queue", // 设置第31天浏览器标签页标题
  description: "Day 31：Queue Runtime V1，本地 Job Queue、JobStore、Worker、Queue Dashboard、Job Timeline 与 Queue Metrics。", // 设置第31天页面描述
}; // metadata 定义结束
