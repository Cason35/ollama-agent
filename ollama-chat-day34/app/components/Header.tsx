      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h1 className="mt-1 text-2xl font-semibold tracking-tight text-zinc-900 dark:text-zinc-50 sm:text-3xl">
            Queue Runtime V4 · Concurrency + Worker Pool
          </h1>
          <p className="mt-2 max-w-2xl text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
            第34天：在 day33 的 Queue Runtime V3 基础上升级 Queue Runtime V4，支持 Concurrent Workers、Worker Pool、
            job lock、heartbeat、stale lock 与 Concurrency Metrics，同时保留 priority / schedule / retry / backoff / DLQ。侧栏仍可 Import 笔记、观察向量写入并调试检索；需
            Ollama{" "}
